...
public:
   ...
   */
  static mrousavy::TypedArrayBase createJSBufferForTensor(jsi::Runtime& runtime, TFLTensor* tensor);
  /**
   Copies the Tensor's data into a jsi::TypedArray and correctly casts to the given type.
   */
  static void updateJSBuffer(jsi::Runtime& runtime, mrousavy::TypedArrayBase& jsBuffer, TFLTensor* tensor);
