...
public final class NitroTfliteAutolinking {
  ...
  public static func createAssetLoader() -> bridge.std__shared_ptr_HybridAssetLoaderSpec_ {
    ...
    return { () -> bridge.std__shared_ptr_HybridAssetLoaderSpec_ in
      let __cxxWrapped = hybridObject.getCxxWrapper()
      return __cxxWrapped.getCxxPart()
    }()
  }
  
  public static func isAssetLoaderRecyclable() -> Bool {
    return HybridAssetLoader.self is any RecyclableView.Type
  }
}
